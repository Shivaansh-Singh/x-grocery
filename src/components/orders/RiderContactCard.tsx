...
export function RiderContactCard({
  ...
  return (
    <div className="glass-card text-[#F5F6FA] p-4 rounded-[20px] shadow-md space-y-3">
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-[#FF6B1A] to-[#2D6CFF] flex items-center justify-center text-white font-bold shrink-0">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <div>
            <h4 className="font-display font-extrabold text-sm leading-tight text-[#F5F6FA]">{displayRiderName}</h4>
        ...
        <a
          ...
          className="px-3.5 py-2 bg-[#2D6CFF] hover:bg-[#2D6CFF]/90 text-white rounded-xl text-xs font-bold transition-colors flex items-center gap-1.5 shrink-0 shadow-xs border border-[#2D6CFF]"
        >
